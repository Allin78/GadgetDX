...
public class DeviceSettingsPreferenceConst {
    ...
    public static final String PREF_FREEBUDS5I_INEAR = "pref_freebuds_inear_detection";
    public static final String PREF_FREEBUDS5I_AUDIOMODE = "pref_freebuds_audiomode";
