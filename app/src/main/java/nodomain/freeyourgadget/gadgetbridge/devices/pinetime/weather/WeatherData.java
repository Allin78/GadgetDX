...
public class WeatherData {
    ...
    public static final ConditionType mapOpenWeatherConditionToPineTimeCondition(int openWeatherMapCondition) {
        switch (openWeatherMapCondition) {
            ...
            case 314:  // Heavy shower rain and drizzle
            case 321:  // Shower drizzle
                return ConditionType.ShowerRain;
            // Group 5xx: Rain
            case 500:  // Light rain
            case 501:  // Moderate rain
            case 502:  // Heavy intensity rain
            ...
            case 802:  // Scattered clouds
                return ConditionType.ScatteredClouds;
            case 803:  // Broken clouds
            case 804:  // Overcast clouds
                return ConditionType.BrokenClouds;
            default:
    ...
    /**
     * How condition events are stored
     */
    static public class Condition extends TimelineHeader {
        /**
         * Condition event's type
         */
        ConditionType type;
