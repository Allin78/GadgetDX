...
/**
 * Coordinator for the Even Realities G1 smart glasses. Describes the supported capabilities of the device.
...
public class G1DeviceCoordinator extends AbstractBLEDeviceCoordinator {
  ...
  protected Pattern getSupportedDeviceName() {
    ...
    // Note that the G1_XX_L_YYYYY will have a corresponding G1_XX_R_ZZZZZ. The XX will match, but the trailing 5
    // characters will not.
