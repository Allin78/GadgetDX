...
public class RecordedDataTypes {
    ...
    public static final int TYPE_STRESS       = 0x00000020;
    public static final int TYPE_SPO2         = 0x00000040;
    public static final int TYPE_PAI          = 0x00000080;
    public static final int TYPE_RESTING_HR   = 0x00000100;
    public static final int TYPE_MANUAL_HR    = 0x00000200;
