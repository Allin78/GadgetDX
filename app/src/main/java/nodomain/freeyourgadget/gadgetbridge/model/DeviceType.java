...
public enum DeviceType {
    ...
    VESC_NRF(440, R.drawable.ic_devices_other, R.drawable.ic_devices_other, R.string.devicetype_vesc),
    VESC_HM10(441, R.drawable.ic_devices_other, R.drawable.ic_devices_other, R.string.devicetype_vesc),
