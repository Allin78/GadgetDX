...
public class Weather {
    ...
    private ArrayList<WeatherSpec> weatherSpecs = new ArrayList<>();
...
//Group 90x: Extreme
    ...
    public void saveToCache() {
        if (weatherSpecs == null || weatherSpecs.isEmpty() || cacheFile == null) {
            return;
        }
