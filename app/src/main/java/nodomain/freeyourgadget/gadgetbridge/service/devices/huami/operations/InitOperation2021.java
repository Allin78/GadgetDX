...
import nodomain.freeyourgadget.gadgetbridge.service.devices.huami.HuamiChunked2021Decoder;
import nodomain.freeyourgadget.gadgetbridge.service.devices.huami.HuamiChunked2021Encoder;
...
public class InitOperation2021 extends InitOperation implements Huami2021Handler {
    ...
    private final HuamiChunked2021Encoder huamiChunked2021Encoder;
    private final HuamiChunked2021Decoder huamiChunked2021Decoder;
    ...
    public InitOperation2021(final boolean needsAuth,
                             ...
                             final HuamiChunked2021Encoder huamiChunked2021Encoder,
                             final HuamiChunked2021Decoder huamiChunked2021Decoder) {
        super(needsAuth, authFlags, cryptFlags, support, builder);
        this.huamiChunked2021Encoder = huamiChunked2021Encoder;
        this.huamiChunked2021Decoder = huamiChunked2021Decoder;
        this.huamiChunked2021Decoder.setHuami2021Handler(this);
    }
    ...
    protected void doPerform() {
        ...
        //testAuth();
        huamiChunked2021Encoder.write(builder, HuamiService.CHUNKED2021_ENDPOINT_AUTH, sendPubkeyCommand, true, false);
    }
    ...
    public boolean onCharacteristicChanged(BluetoothGatt gatt,
        ...
        this.huamiChunked2021Decoder.decode(value);
        return true;
    }

    @Override
    public void handle2021Payload(final int type, final byte[] payload) {
        if (type != HuamiService.CHUNKED2021_ENDPOINT_AUTH) {
        ...
        if (payload[0] == 0x10 && payload[1] == 0x04 && payload[2] == 0x01) {
            ...
            huamiChunked2021Encoder.setEncryptionParameters(encryptedSequenceNumber, finalSharedSessionAES);
            huamiChunked2021Decoder.setEncryptionParameters(finalSharedSessionAES);
            ...
            try {
                ...
                if (encryptedRandom1.length == 16 && encryptedRandom2.length == 16) {
                    ...
                    huamiChunked2021Encoder.write(builder, HuamiService.CHUNKED2021_ENDPOINT_AUTH, command, true, false);
