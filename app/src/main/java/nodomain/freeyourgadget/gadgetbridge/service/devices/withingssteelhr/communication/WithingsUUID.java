...
public final class WithingsUUID {
    ...
    public static final UUID WITHINGS_APP_SERVICE_UUID = UUID.fromString("10000057-5749-5448-0037-00000000000000");
    public static final UUID INIT_NOTIFICATIONS_CHARACTERISTIC_UUID = UUID.fromString("10000059-5749-5448-0037-00000000000000");
    public static final UUID INIT_NOTIFICATIONS_RESPONSE_CHARACTERISTIC_UUID = UUID.fromString("10000058-5749-5448-0037-00000000000000");
    public static final UUID HANDLE_NOTIFICATIONS_CHARACTERISTIC_UUID = UUID.fromString("1000005a-5749-5448-0037-00000000000000");
