...
public class HuaweiP2PCalendarService extends HuaweiBaseP2PService {
    ...
    private JsonObject calendarEventToJson(CalendarEvent calendarEvent) {
        ...
        ret.addProperty("state", -1);  // TODO: see handleData function command ID 3 for details
    ...
    private JsonObject calendarDeletedEventToJson(CalendarEvent calendarEvent) {
        ...
        ret.addProperty("event_uuid", String.valueOf(calendarEvent.getId()) + "_" + calendarEvent.getBegin());  //TODO:
    ...
    private boolean sendCalendarFile(String majorVersion, short minorVersion, short scheduleCount) {
        ...
        try {
            ...
            //GB.toast(getContext(), "Failed to send file upload info", Toast.LENGTH_SHORT, GB.ERROR, e);
    ...
    public void handleData(byte[] data) {
        try {
            ...
            if (commandId == 1) {
                ...
                final boolean pollingEnabled = GBApplication.getDeviceSpecificSharedPrefs(manager.getSupportProvider().getDevice().getAddress()).getBoolean(HuaweiConstants.PREF_HUAWEI_CALENDAR_SYNC_POLLING, false);
                if(pollingEnabled) {
