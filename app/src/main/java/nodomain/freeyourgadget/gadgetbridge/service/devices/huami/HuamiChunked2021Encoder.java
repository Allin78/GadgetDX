...
public class HuamiChunked2021Encoder {
    private static final Logger LOG = LoggerFactory.getLogger(HuamiChunked2021Encoder.class);
    ...
    public HuamiChunked2021Encoder(final BluetoothGattCharacteristic characteristicChunked2021Write,
